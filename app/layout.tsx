...
export const metadata: Metadata = {
  ...
  title: 'Private AI Chief of Staff Setup | Live in 24 Hours | $1,000 | OpenClaw',
  description: 'White-glove AI assistant setup for executives. Deploy your private AI chief of staff in under 24 hours for $1,000. Save 10-20 hours/week. No vendor lock-in. 100% satisfaction guarantee. Trusted by 50+ executives.',
  keywords: [
    'AI assistant setup',
    'private AI chief of staff',
    'executive AI assistant setup',
    'AI chief of staff deployment',
    ...
    'AI productivity for executives',
  ...
  openGraph: {
    title: 'Your Private AI Chief of Staff - Live in 24 Hours | OpenClaw Setup',
    description: 'White-glove AI assistant setup for executives. Save 10-20 hours/week. $1,000 flat fee. 100% satisfaction guarantee. Trusted by 50+ executives at $5-50M companies.',
    type: 'website',
    locale: 'en_US',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'OpenClaw Private Setup - Your AI Chief of Staff, Live in 24 Hours',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Your Private AI Chief of Staff - Live in 24 Hours',
    description: 'White-glove setup for executives. Save 10-20 hours/week. $1,000 flat fee. 100% satisfaction guarantee.',
    images: ['/og-image.svg'],
    creator: '@openclaw',
  },
  robots: {
